...
the answer isnsimple, instead of using JSON you simply define a native JavaScript object using sll the syntactic sugar, and use Function constructor to parse it instead of `JSON.parse()`.
